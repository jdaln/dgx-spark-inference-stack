...
echo "WARNING: legacy script retained for historical reference only." >&2
echo "WARNING: prefer tools/validate-stack.sh, tools/run-model.sh, tools/smoke-gateway.sh, and tools/soak-context.mjs." >&2
